...
import com.aelcorporation.krishipatra.activity.HomeActivity;
...
public class CustomVideoSubListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final com.aelcorporation.krishipatra.onClickListners.onVideoListClick onVideoListClick;
        ...
        switch (viewType) {
            ...
            default: {
                if (holder instanceof MyViewSubListHolder) {
                    ...
                    Picasso.with(context).load(context.getString(R.string.link)+"images/thumbnail/" + ((videoListGetSet) data.get(position)).getVideoImage()).into(((MyViewSubListHolder) holder).iv_video);
