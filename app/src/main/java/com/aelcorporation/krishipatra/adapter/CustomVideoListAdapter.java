        ...
        switch (viewType) {
            ...
            default: {
                if (holder instanceof MyViewHolder) {
                    ...
                    Picasso.with(context).load(context.getString(R.string.link) + "images/thumbnail/" + ((videoListGetSet) data.get(position)).getVideoImage()).into(((MyViewHolder) holder).iv_video);
                }
            }
